...
class m250526_190458_create_fleet_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex('idx-fleet-mining_process_id', '{{%fleet}}', 'mining_process_id');
        ...
        $this->addForeignKey('fk_fleet_process', '{{%fleet}}', 'mining_process_id', '{{%mining_process}}', 'id', 'CASCADE');
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey('fk_fleet_process', '{{%fleet}}');
        ...
        $this->dropIndex('idx-fleet-mining_process_id', '{{%fleet}}');
