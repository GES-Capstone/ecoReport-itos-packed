...
/**
 * Handles the creation of table `{{%mining_process}}`.
 */
class m250522_180950_create_mining_process_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex('idx-mining_process-mining_group_id', '{{%mining_process}}', 'mining_group_id');
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey('fk-mining_process-mining_group_id', '{{%mining_process}}');

        $this->dropIndex('idx-mining_process-location_id', '{{%mining_process}}');
        $this->dropIndex('idx-mining_process-company_id', '{{%mining_process}}');
        $this->dropIndex('idx-mining_process-mining_group_id', '{{%mining_process}}');
