...
<div class="container-profile">
    <p class="text-center fw-bold display-4 my-4"><?= Yii::t('backend', 'Mining Group Data Entry') ?></p>
    ...
    <div class="text-center mt-4">
        ...
        <?php if ($config->step >= 2): ?>
            <?= Html::a(Yii::t('backend', 'Next'), ['initial-configuration/step2'], ['class' => 'btn btn-primary ms-2 px-4']) ?>
        <?php endif; ?>
    </div>
